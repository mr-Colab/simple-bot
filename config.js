...
module.exports = {
	...
	AUDIO_DATA: process.env.AUDIO_DATA || "LD7 V1;Shizzy andy;https://url.sparky.biz.id/5ftLiA.jpg",
	AUTO_STATUS_VIEW: toBool(process.env.AUTO_STATUS_VIEW || "true"),
	BOT_INFO: process.env.BOT_INFO || "LD7 V1;Shizzy andy;https://url.sparky.biz.id/5ftLiA.jpg",
	...
	MENU_TYPE: process.env.MENU_TYPE || "button", // Menu style: big, small, image, document, text, call, payment
	...
	PHONE_NUMBER: process.env.PHONE_NUMBER || "13056978303",
	START_MSG: toBool(process.env.START_MSG || "true"),
	STICKER_DATA: process.env.STICKER_DATA || `LD7 V1;Shizzy andy`,
	SUDO: process.env.SUDO || "13056978303",
